var baseFolder = "Fresco/ESP32Cam/ESP32CAM Data Gathering/" // make sure to add last "/" (e.g. "parent/child/")

function doPost(e) {
  
  // grab parameters
  var folderName = Utilities.formatDate(new Date(), Session.getScriptTimeZone(), "yyyy-MM-dd"); // placed in baseFolder (e.g. parent/child/folderName/img.jpg)
  var fileName = e.parameter.fileName + "-" +  Utilities.formatDate(new Date(), Session.getScriptTimeZone(), "HH-mm-ss") + ".jpg";
